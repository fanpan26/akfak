...
import com.fanpan26.akfak.common.errors.BrokerNotAvailableException;
import com.fanpan26.akfak.common.errors.ClusterAuthorizationException;
import com.fanpan26.akfak.common.errors.ControllerMovedException;
import com.fanpan26.akfak.common.errors.CorruptRecordException;
import com.fanpan26.akfak.common.errors.GroupAuthorizationException;
import com.fanpan26.akfak.common.errors.GroupCoordinatorNotAvailableException;
import com.fanpan26.akfak.common.errors.GroupLoadInProgressException;
import com.fanpan26.akfak.common.errors.IllegalGenerationException;
import com.fanpan26.akfak.common.errors.IllegalSaslStateException;
import com.fanpan26.akfak.common.errors.InconsistentGroupProtocolException;
import com.fanpan26.akfak.common.errors.InvalidCommitOffsetSizeException;
import com.fanpan26.akfak.common.errors.InvalidFetchSizeException;
import com.fanpan26.akfak.common.errors.InvalidGroupIdException;
import com.fanpan26.akfak.common.errors.InvalidRequiredAcksException;
import com.fanpan26.akfak.common.errors.InvalidSessionTimeoutException;
import com.fanpan26.akfak.common.errors.InvalidTimestampException;
import com.fanpan26.akfak.common.errors.InvalidTopicException;
import com.fanpan26.akfak.common.errors.LeaderNotAvailableException;
import com.fanpan26.akfak.common.errors.NetworkException;
import com.fanpan26.akfak.common.errors.NotCoordinatorForGroupException;
import com.fanpan26.akfak.common.errors.NotEnoughReplicasAfterAppendException;
import com.fanpan26.akfak.common.errors.NotEnoughReplicasException;
import com.fanpan26.akfak.common.errors.NotLeaderForPartitionException;
import com.fanpan26.akfak.common.errors.OffsetMetadataTooLarge;
import com.fanpan26.akfak.common.errors.OffsetOutOfRangeException;
import com.fanpan26.akfak.common.errors.RebalanceInProgressException;
import com.fanpan26.akfak.common.errors.RecordBatchTooLargeException;
import com.fanpan26.akfak.common.errors.RecordTooLargeException;
import com.fanpan26.akfak.common.errors.ReplicaNotAvailableException;
import com.fanpan26.akfak.common.errors.RetriableException;
...
import com.fanpan26.akfak.common.errors.UnknownMemberIdException;
import com.fanpan26.akfak.common.errors.UnknownServerException;
import com.fanpan26.akfak.common.errors.UnknownTopicOrPartitionException;
import com.fanpan26.akfak.common.errors.UnsupportedSaslMechanismException;
import com.fanpan26.akfak.common.errors.UnsupportedVersionException;
